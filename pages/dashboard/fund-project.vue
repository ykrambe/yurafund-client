...
onMounted(() => {
  campaignStore.getCampaignToFund()
})
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Manage other campaigns and fund your favorite projects' }
  ]
})
            ...
            <div class="flex-1 p-6 lg:p-8">
              <div class="flex flex-col justify-between h-full">
                ...
                <div class="flex flex-wrap gap-3">
                  <UButton :to="`/projects/${campaign.id}`" color="primary" variant="solid" size="md" class="text-black">
                    <UIcon name="i-heroicons-banknotes" class="mr-1" />
                    Fund Project
                  </UButton>
                </div>
